...
public class patient extends user {
	...
	public patient(String username, String passwd, Long clientID, String name, String familyName, Long cIN, Long cnamID,
			String dateOfBirth, String address, String sex) {
		super(clientID, username, passwd, true, "USER");
		this.name = name;
